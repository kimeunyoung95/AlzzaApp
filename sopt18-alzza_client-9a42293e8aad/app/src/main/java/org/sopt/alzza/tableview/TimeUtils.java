...
public class TimeUtils {
    ...
    public static final SimpleDateFormat a_format = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.KOREA);
        ...
        try{
            ...
            if (System.currentTimeMillis() - _timestamp < 1 * 60 * 1000){
                ...
                if (c.get(Calendar.YEAR) == now.get(Calendar.YEAR)
                    ...
                    SimpleDateFormat sdf = new SimpleDateFormat("today HH:mm");
    ...
    public static String getWeekDayString2(Date date) {
        String weekString = "";
        final String dayNames[] = { "일", "월", "화", "수", "목", "금","토" };
